...
The complete list of variables of each feature vector is available in 'features.txt' in Samsung data.

## Applied transformations description
Following transformations were applied to Samsung data set:
